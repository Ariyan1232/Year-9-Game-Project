...
while validInput == False:
    ...
    if "start" in start.lower():
      ...
      begin1 = "In this game, you will be required to find the mysteries of one of the most technological advanced cities in the world. In this game, you need to complete a certain amount of tasks. In this game you will have to type something up when you see two arrows which looks like this '>>'. Most of the time, you will need to type in word(s) that are included in brackets which look like this '()'. Sometimes, the question may not provide you with words to type in, so you may have to type in what you think the answers should be. Good luck and I hope you enjoy your adventure! If you are ready, type in the word (begin)"
      while b < len(begin1):
